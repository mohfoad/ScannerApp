/**
* The functions in this file are used by the various
* validated inputs to check their validaty and bubble
* it up to their parent form screens for holistic (form-wide) validations
*/
...
export const PHONE_REGEX = /^\(*\+*[1-9]{0,3}\)*-*[1-9]{0,3}[-. /]*\(*[2-9]\d{2}\)*[-. /]*\d{3}[-. /]*\d{4} *e*x*t*\.* *\d{0,4}$/
export const NUMERIC_REGEX = /^[\d\.,]+$/
export const URL_REGEX = /^(http(s?)|ftp):\/\/[^ ]+$/

export const requiredValidator = val =>
  pathOr(0, ['length'], val) !== 0
